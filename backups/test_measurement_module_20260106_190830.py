...
Run: python test_measurement_simple.py
"""
...
try:
    ...
    print("✅ FairnessAnalyzer imported successfully")
    ...
    print("  2. __init__.py has: from measurement_module.src.fairness_analyzer_simple import FairnessAnalyzer")
    sys.exit(1)

...
│
├── 📂 shared/                           # Shared utilities (4 core files)
...
│
└── 🧪 Test Files
    ├── test_measurement_module.py       # Measurement module tests
    ├── test_pipeline_module.py          # Pipeline module tests
    ├── test_training_module.py          # Training module tests
    ├── test_monitoring_module.py        # Monitoring module tests
    ├── test_shared_modules.py           # Shared utilities tests
    └── test_with_real_dataset.py        # Integration tests with real data
```
...
- **GitHub Issues**: [Report bugs or request features](https://github.com/fifa0209/fairness_toolkit/issues)
- **Documentation**: Check module-specific READMEs for detailed guides
- **Enhancements**: See `Enhancement.md` for planned features
